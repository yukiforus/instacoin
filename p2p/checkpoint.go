...
// specified index.
func DownloadCheckpoint(ctx context.Context, addr string, genesisID instacoin.BlockID, index instacoin.ChainIndex) (consensus.Checkpoint, error) {
	// construct handshake
	ours := peerHandshake{
		Version: 1,
		Genesis: genesisID,
		Tip:     instacoin.ChainIndex{Height: 0, ID: genesisID},
	}
