// Package instacoin defines the basic types and functions of the instacoin
// system.
package instacoin
...
// HashBytes computes the hash of b using instacoin's hash function.
...
// A Hasher hashes data using instacoin's hash function.
type Hasher struct {
	h   hash.Hash
	buf [64]byte
}
...
// NewHasher returns a Hasher instance for instacoin's hash function.
