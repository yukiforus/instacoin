...
func (sc *ScratchChain) AppendHeader(h instacoin.BlockHeader) error {
...
// exist in the chain.
func (sc *ScratchChain) ApplyBlock(b instacoin.Block) (Checkpoint, error) {
...
func (sc *ScratchChain) UnvalidatedBase() instacoin.ChainIndex {
...
func (sc *ScratchChain) ValidTip() instacoin.ChainIndex {
	return sc.tvc.Index
}
...
func (sc *ScratchChain) TotalWork() instacoin.Work {
...
func (sc *ScratchChain) Contains(index instacoin.ChainIndex) bool {
...
func (sc *ScratchChain) Unvalidated() []instacoin.ChainIndex {
	headers := sc.headers[sc.tvc.Index.Height-sc.Base().Height:]
	indices := make([]instacoin.ChainIndex, len(headers))
	for i := range indices {
