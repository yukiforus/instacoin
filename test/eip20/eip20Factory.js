...
contract('EIP20Factory', (accounts) => {
  it('Verify a Human Standard Token once deployed using both verification functions.', async () => {
    ...
    const newTokenAddr = await factory.createEIP20.call(100000, 'instaCoin', 2, 'INC', { from: accounts[0] });
    await factory.createEIP20(100000, 'instaCoin', 2, 'INC', { from: accounts[0] });
