...
func init() {
	file_insta_authz_v1beta1_event_proto_init()
	md_EventGrant = File_insta_authz_v1beta1_event_proto.Messages().ByName("EventGrant")
...
func (x *EventGrant) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_authz_v1beta1_event_proto_msgTypes[0]
...
func (x *fastReflection_EventGrant) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.authz.v1beta1.EventGrant.msg_type_url":
		return x.MsgTypeUrl != ""
	case "insta.authz.v1beta1.EventGrant.granter":
		return x.Granter != ""
	case "insta.authz.v1beta1.EventGrant.grantee":
		return x.Grantee != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.authz.v1beta1.EventGrant"))
		}
		panic(fmt.Errorf("message insta.authz.v1beta1.EventGrant does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EventGrant) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.authz.v1beta1.EventGrant does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EventGrant) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "insta.authz.v1beta1.EventGrant.msg_type_url":
		panic(fmt.Errorf("field msg_type_url of message insta.authz.v1beta1.EventGrant is not mutable"))
	case "insta.authz.v1beta1.EventGrant.granter":
		panic(fmt.Errorf("field granter of message insta.authz.v1beta1.EventGrant is not mutable"))
	case "insta.authz.v1beta1.EventGrant.grantee":
		panic(fmt.Errorf("field grantee of message insta.authz.v1beta1.EventGrant is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.authz.v1beta1.EventGrant"))
		}
...
func (x *fastReflection_EventGrant) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.authz.v1beta1.EventGrant", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_insta_authz_v1beta1_event_proto_init()
	md_EventRevoke = File_insta_authz_v1beta1_event_proto.Messages().ByName("EventRevoke")
...
func (x *EventRevoke) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_authz_v1beta1_event_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_EventRevoke) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.authz.v1beta1.EventRevoke.msg_type_url":
		return x.MsgTypeUrl != ""
	case "insta.authz.v1beta1.EventRevoke.granter":
		return x.Granter != ""
	case "insta.authz.v1beta1.EventRevoke.grantee":
		return x.Grantee != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.authz.v1beta1.EventRevoke"))
		}
		panic(fmt.Errorf("message insta.authz.v1beta1.EventRevoke does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EventRevoke) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.authz.v1beta1.EventRevoke does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EventRevoke) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "insta.authz.v1beta1.EventRevoke.msg_type_url":
		panic(fmt.Errorf("field msg_type_url of message insta.authz.v1beta1.EventRevoke is not mutable"))
	case "insta.authz.v1beta1.EventRevoke.granter":
		panic(fmt.Errorf("field granter of message insta.authz.v1beta1.EventRevoke is not mutable"))
	case "insta.authz.v1beta1.EventRevoke.grantee":
		panic(fmt.Errorf("field grantee of message insta.authz.v1beta1.EventRevoke is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.authz.v1beta1.EventRevoke"))
		}
...
func (x *fastReflection_EventRevoke) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.authz.v1beta1.EventRevoke", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: insta/authz/v1beta1/event.proto
...
func (*EventGrant) Descriptor() ([]byte, []int) {
	return file_insta_authz_v1beta1_event_proto_rawDescGZIP(), []int{0}
}
...
func (*EventRevoke) Descriptor() ([]byte, []int) {
	return file_insta_authz_v1beta1_event_proto_rawDescGZIP(), []int{1}
}
...
var File_insta_authz_v1beta1_event_proto protoreflect.FileDescriptor

var file_insta_authz_v1beta1_event_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x96, 0x01, 0x0a, 0x0a, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x47, 0x72, 0x61,
	...
	0x69, 0x6e, 0x67, 0x52, 0x07, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x65, 0x65, 0x22, 0x97, 0x01, 0x0a,
	0x0b, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x76, 0x6f, 0x6b, 0x65, 0x12, 0x20, 0x0a, 0x0c,
	0x6d, 0x73, 0x67, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0a, 0x6d, 0x73, 0x67, 0x54, 0x79, 0x70, 0x65, 0x55, 0x72, 0x6c, 0x12, 0x32,
	0x0a, 0x07, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42,
...
var (
	file_insta_authz_v1beta1_event_proto_rawDescOnce sync.Once
	file_insta_authz_v1beta1_event_proto_rawDescData = file_insta_authz_v1beta1_event_proto_rawDesc
)

func file_insta_authz_v1beta1_event_proto_rawDescGZIP() []byte {
	file_insta_authz_v1beta1_event_proto_rawDescOnce.Do(func() {
		file_insta_authz_v1beta1_event_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_authz_v1beta1_event_proto_rawDescData)
	})
	return file_insta_authz_v1beta1_event_proto_rawDescData
}

var file_insta_authz_v1beta1_event_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_insta_authz_v1beta1_event_proto_goTypes = []interface{}{
	(*EventGrant)(nil),  // 0: insta.authz.v1beta1.EventGrant
	(*EventRevoke)(nil), // 1: insta.authz.v1beta1.EventRevoke
}
var file_insta_authz_v1beta1_event_proto_depIdxs = []int32{
...
func init() { file_insta_authz_v1beta1_event_proto_init() }
func file_insta_authz_v1beta1_event_proto_init() {
	if File_insta_authz_v1beta1_event_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_insta_authz_v1beta1_event_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_insta_authz_v1beta1_event_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_authz_v1beta1_event_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_insta_authz_v1beta1_event_proto_goTypes,
		DependencyIndexes: file_insta_authz_v1beta1_event_proto_depIdxs,
		MessageInfos:      file_insta_authz_v1beta1_event_proto_msgTypes,
	}.Build()
	File_insta_authz_v1beta1_event_proto = out.File
	file_insta_authz_v1beta1_event_proto_rawDesc = nil
	file_insta_authz_v1beta1_event_proto_goTypes = nil
	file_insta_authz_v1beta1_event_proto_depIdxs = nil
}
