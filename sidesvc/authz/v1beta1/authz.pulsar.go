...
func init() {
	...
	md_GenericAuthorization = File_insta_authz_v1beta1_authz_proto.Messages().ByName("GenericAuthorization")
...
func (x *GenericAuthorization) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_authz_v1beta1_authz_proto_msgTypes[0]
...
func (x *fastReflection_GenericAuthorization) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.authz.v1beta1.GenericAuthorization.msg":
		return x.Msg != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.authz.v1beta1.GenericAuthorization"))
		}
		panic(fmt.Errorf("message insta.authz.v1beta1.GenericAuthorization does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenericAuthorization) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.authz.v1beta1.GenericAuthorization does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenericAuthorization) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "insta.authz.v1beta1.GenericAuthorization.msg":
		panic(fmt.Errorf("field msg of message insta.authz.v1beta1.GenericAuthorization is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.authz.v1beta1.GenericAuthorization"))
		}
...
func (x *fastReflection_GenericAuthorization) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.authz.v1beta1.GenericAuthorization", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_insta_authz_v1beta1_authz_proto_init()
	md_Grant = File_insta_authz_v1beta1_authz_proto.Messages().ByName("Grant")
...
func (x *Grant) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_authz_v1beta1_authz_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Grant) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.authz.v1beta1.Grant.authorization":
		return x.Authorization != nil
	case "insta.authz.v1beta1.Grant.expiration":
		return x.Expiration != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.authz.v1beta1.Grant"))
		}
		panic(fmt.Errorf("message insta.authz.v1beta1.Grant does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Grant) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.authz.v1beta1.Grant does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Grant) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.authz.v1beta1.Grant", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_insta_authz_v1beta1_authz_proto_init()
	md_GrantAuthorization = File_insta_authz_v1beta1_authz_proto.Messages().ByName("GrantAuthorization")
...
func (x *GrantAuthorization) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_authz_v1beta1_authz_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_GrantAuthorization) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.authz.v1beta1.GrantAuthorization.granter":
		return x.Granter != ""
	case "insta.authz.v1beta1.GrantAuthorization.grantee":
		return x.Grantee != ""
	case "insta.authz.v1beta1.GrantAuthorization.authorization":
		return x.Authorization != nil
	case "insta.authz.v1beta1.GrantAuthorization.expiration":
		return x.Expiration != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.authz.v1beta1.GrantAuthorization"))
		}
		panic(fmt.Errorf("message insta.authz.v1beta1.GrantAuthorization does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GrantAuthorization) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.authz.v1beta1.GrantAuthorization does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GrantAuthorization) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "insta.authz.v1beta1.GrantAuthorization.expiration":
		...
		return protoreflect.ValueOfMessage(x.Expiration.ProtoReflect())
	case "insta.authz.v1beta1.GrantAuthorization.granter":
		panic(fmt.Errorf("field granter of message insta.authz.v1beta1.GrantAuthorization is not mutable"))
	case "insta.authz.v1beta1.GrantAuthorization.grantee":
		panic(fmt.Errorf("field grantee of message insta.authz.v1beta1.GrantAuthorization is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.authz.v1beta1.GrantAuthorization"))
		}
...
func (x *fastReflection_GrantAuthorization) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.authz.v1beta1.GrantAuthorization", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_insta_authz_v1beta1_authz_proto_init()
	md_GrantQueueItem = File_insta_authz_v1beta1_authz_proto.Messages().ByName("GrantQueueItem")
...
func (x *GrantQueueItem) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_authz_v1beta1_authz_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_GrantQueueItem) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.authz.v1beta1.GrantQueueItem.msg_type_urls":
		return len(x.MsgTypeUrls) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.authz.v1beta1.GrantQueueItem"))
		}
		panic(fmt.Errorf("message insta.authz.v1beta1.GrantQueueItem does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GrantQueueItem) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.authz.v1beta1.GrantQueueItem does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GrantQueueItem) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.authz.v1beta1.GrantQueueItem", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: insta/authz/v1beta1/authz.proto
...
func (*GenericAuthorization) Descriptor() ([]byte, []int) {
	return file_insta_authz_v1beta1_authz_proto_rawDescGZIP(), []int{0}
}
...
func (*Grant) Descriptor() ([]byte, []int) {
	return file_insta_authz_v1beta1_authz_proto_rawDescGZIP(), []int{1}
}
...
func (*GrantAuthorization) Descriptor() ([]byte, []int) {
	return file_insta_authz_v1beta1_authz_proto_rawDescGZIP(), []int{2}
}
...
func (*GrantQueueItem) Descriptor() ([]byte, []int) {
	return file_insta_authz_v1beta1_authz_proto_rawDescGZIP(), []int{3}
}
...
var File_insta_authz_v1beta1_authz_proto protoreflect.FileDescriptor

var file_insta_authz_v1beta1_authz_proto_rawDesc = []byte{
	...
	0x6e, 0x22, 0x8d, 0x02, 0x0a, 0x12, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x41, 0x75, 0x74, 0x68, 0x6f,
	0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x32, 0x0a, 0x07, 0x67, 0x72, 0x61, 0x6e,
	...
	,
	...
	,
}

var (
	file_insta_authz_v1beta1_authz_proto_rawDescOnce sync.Once
	file_insta_authz_v1beta1_authz_proto_rawDescData = file_insta_authz_v1beta1_authz_proto_rawDesc
)

func file_insta_authz_v1beta1_authz_proto_rawDescGZIP() []byte {
	file_insta_authz_v1beta1_authz_proto_rawDescOnce.Do(func() {
		file_insta_authz_v1beta1_authz_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_authz_v1beta1_authz_proto_rawDescData)
	})
	return file_insta_authz_v1beta1_authz_proto_rawDescData
}

var file_insta_authz_v1beta1_authz_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_insta_authz_v1beta1_authz_proto_goTypes = []interface{}{
	(*GenericAuthorization)(nil),  // 0: insta.authz.v1beta1.GenericAuthorization
	(*Grant)(nil),                 // 1: insta.authz.v1beta1.Grant
	(*GrantAuthorization)(nil),    // 2: insta.authz.v1beta1.GrantAuthorization
	(*GrantQueueItem)(nil),        // 3: insta.authz.v1beta1.GrantQueueItem
	(*anypb.Any)(nil),             // 4: google.protobuf.Any
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
}
var file_insta_authz_v1beta1_authz_proto_depIdxs = []int32{
	4, // 0: insta.authz.v1beta1.Grant.authorization:type_name -> google.protobuf.Any
	5, // 1: insta.authz.v1beta1.Grant.expiration:type_name -> google.protobuf.Timestamp
	4, // 2: insta.authz.v1beta1.GrantAuthorization.authorization:type_name -> google.protobuf.Any
	5, // 3: insta.authz.v1beta1.GrantAuthorization.expiration:type_name -> google.protobuf.Timestamp
...
func init() { file_insta_authz_v1beta1_authz_proto_init() }
func file_insta_authz_v1beta1_authz_proto_init() {
	if File_insta_authz_v1beta1_authz_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_insta_authz_v1beta1_authz_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_insta_authz_v1beta1_authz_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Grant); i {
			case 0:
				return &v.state
			case 1:
		...
		file_insta_authz_v1beta1_authz_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_insta_authz_v1beta1_authz_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_authz_v1beta1_authz_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_insta_authz_v1beta1_authz_proto_goTypes,
		DependencyIndexes: file_insta_authz_v1beta1_authz_proto_depIdxs,
		MessageInfos:      file_insta_authz_v1beta1_authz_proto_msgTypes,
	}.Build()
	File_insta_authz_v1beta1_authz_proto = out.File
	file_insta_authz_v1beta1_authz_proto_rawDesc = nil
	file_insta_authz_v1beta1_authz_proto_goTypes = nil
	file_insta_authz_v1beta1_authz_proto_depIdxs = nil
}
