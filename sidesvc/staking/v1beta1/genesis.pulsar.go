...
func init() {
	file_insta_staking_v1beta1_genesis_proto_init()
	md_GenesisState = File_insta_staking_v1beta1_genesis_proto.Messages().ByName("GenesisState")
...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_staking_v1beta1_genesis_proto_msgTypes[0]
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.staking.v1beta1.GenesisState.params":
		return x.Params != nil
	case "insta.staking.v1beta1.GenesisState.last_total_power":
		return len(x.LastTotalPower) != 0
	case "insta.staking.v1beta1.GenesisState.last_validator_powers":
		return len(x.LastValidatorPowers) != 0
	case "insta.staking.v1beta1.GenesisState.validators":
		return len(x.Validators) != 0
	case "insta.staking.v1beta1.GenesisState.delegations":
		return len(x.Delegations) != 0
	case "insta.staking.v1beta1.GenesisState.unbonding_delegations":
		return len(x.UnbondingDelegations) != 0
	case "insta.staking.v1beta1.GenesisState.redelegations":
		return len(x.Redelegations) != 0
	case "insta.staking.v1beta1.GenesisState.exported":
		return x.Exported != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.staking.v1beta1.GenesisState"))
		}
		panic(fmt.Errorf("message insta.staking.v1beta1.GenesisState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.staking.v1beta1.GenesisState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "insta.staking.v1beta1.GenesisState.redelegations":
		...
		return protoreflect.ValueOfList(value)
	case "insta.staking.v1beta1.GenesisState.last_total_power":
		panic(fmt.Errorf("field last_total_power of message insta.staking.v1beta1.GenesisState is not mutable"))
	case "insta.staking.v1beta1.GenesisState.exported":
		panic(fmt.Errorf("field exported of message insta.staking.v1beta1.GenesisState is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.staking.v1beta1.GenesisState"))
		}
...
func (x *fastReflection_GenesisState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.staking.v1beta1.GenesisState", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_insta_staking_v1beta1_genesis_proto_init()
	md_LastValidatorPower = File_insta_staking_v1beta1_genesis_proto.Messages().ByName("LastValidatorPower")
...
func (x *LastValidatorPower) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_staking_v1beta1_genesis_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_LastValidatorPower) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.staking.v1beta1.LastValidatorPower.address":
		return x.Address != ""
	case "insta.staking.v1beta1.LastValidatorPower.power":
		return x.Power != int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.staking.v1beta1.LastValidatorPower"))
		}
		panic(fmt.Errorf("message insta.staking.v1beta1.LastValidatorPower does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_LastValidatorPower) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.staking.v1beta1.LastValidatorPower does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_LastValidatorPower) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "insta.staking.v1beta1.LastValidatorPower.address":
		panic(fmt.Errorf("field address of message insta.staking.v1beta1.LastValidatorPower is not mutable"))
	case "insta.staking.v1beta1.LastValidatorPower.power":
		panic(fmt.Errorf("field power of message insta.staking.v1beta1.LastValidatorPower is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.staking.v1beta1.LastValidatorPower"))
		}
...
func (x *fastReflection_LastValidatorPower) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.staking.v1beta1.LastValidatorPower", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: insta/staking/v1beta1/genesis.proto
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_insta_staking_v1beta1_genesis_proto_rawDescGZIP(), []int{0}
}
...
func (*LastValidatorPower) Descriptor() ([]byte, []int) {
	return file_insta_staking_v1beta1_genesis_proto_rawDescGZIP(), []int{1}
}
...
var File_insta_staking_v1beta1_genesis_proto protoreflect.FileDescriptor

var file_insta_staking_v1beta1_genesis_proto_rawDesc = []byte{
	...
	0x08, 0x88, 0xa0, 0x1f, 0x00, 0xe8, 0xa0, 0x1f, 0x00, 0x42, 0xdc, 0x01, 0x0a, 0x1a, 0x63, 0x6f,
...
var (
	file_insta_staking_v1beta1_genesis_proto_rawDescOnce sync.Once
	file_insta_staking_v1beta1_genesis_proto_rawDescData = file_insta_staking_v1beta1_genesis_proto_rawDesc
)

func file_insta_staking_v1beta1_genesis_proto_rawDescGZIP() []byte {
	file_insta_staking_v1beta1_genesis_proto_rawDescOnce.Do(func() {
		file_insta_staking_v1beta1_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_staking_v1beta1_genesis_proto_rawDescData)
	})
	return file_insta_staking_v1beta1_genesis_proto_rawDescData
}

var file_insta_staking_v1beta1_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_insta_staking_v1beta1_genesis_proto_goTypes = []interface{}{
	(*GenesisState)(nil),        // 0: insta.staking.v1beta1.GenesisState
	(*LastValidatorPower)(nil),  // 1: insta.staking.v1beta1.LastValidatorPower
	(*Params)(nil),              // 2: insta.staking.v1beta1.Params
	(*Validator)(nil),           // 3: insta.staking.v1beta1.Validator
	(*Delegation)(nil),          // 4: insta.staking.v1beta1.Delegation
	(*UnbondingDelegation)(nil), // 5: insta.staking.v1beta1.UnbondingDelegation
	(*Redelegation)(nil),        // 6: insta.staking.v1beta1.Redelegation
}
var file_insta_staking_v1beta1_genesis_proto_depIdxs = []int32{
	2, // 0: insta.staking.v1beta1.GenesisState.params:type_name -> insta.staking.v1beta1.Params
	1, // 1: insta.staking.v1beta1.GenesisState.last_validator_powers:type_name -> insta.staking.v1beta1.LastValidatorPower
	3, // 2: insta.staking.v1beta1.GenesisState.validators:type_name -> insta.staking.v1beta1.Validator
	4, // 3: insta.staking.v1beta1.GenesisState.delegations:type_name -> insta.staking.v1beta1.Delegation
	5, // 4: insta.staking.v1beta1.GenesisState.unbonding_delegations:type_name -> insta.staking.v1beta1.UnbondingDelegation
	6, // 5: insta.staking.v1beta1.GenesisState.redelegations:type_name -> insta.staking.v1beta1.Redelegation
...
func init() { file_insta_staking_v1beta1_genesis_proto_init() }
func file_insta_staking_v1beta1_genesis_proto_init() {
	if File_insta_staking_v1beta1_genesis_proto != nil {
		return
	}
	file_insta_staking_v1beta1_staking_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_insta_staking_v1beta1_genesis_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_insta_staking_v1beta1_genesis_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_staking_v1beta1_genesis_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_insta_staking_v1beta1_genesis_proto_goTypes,
		DependencyIndexes: file_insta_staking_v1beta1_genesis_proto_depIdxs,
		MessageInfos:      file_insta_staking_v1beta1_genesis_proto_msgTypes,
	}.Build()
	File_insta_staking_v1beta1_genesis_proto = out.File
	file_insta_staking_v1beta1_genesis_proto_rawDesc = nil
	file_insta_staking_v1beta1_genesis_proto_goTypes = nil
	file_insta_staking_v1beta1_genesis_proto_depIdxs = nil
}
