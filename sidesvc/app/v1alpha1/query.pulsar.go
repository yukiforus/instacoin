...
func init() {
	file_insta_app_v1alpha1_query_proto_init()
	md_QueryConfigRequest = File_insta_app_v1alpha1_query_proto.Messages().ByName("QueryConfigRequest")
}
...
func (x *QueryConfigRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_app_v1alpha1_query_proto_msgTypes[0]
...
func (x *fastReflection_QueryConfigRequest) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.app.v1alpha1.QueryConfigRequest"))
		}
		panic(fmt.Errorf("message insta.app.v1alpha1.QueryConfigRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryConfigRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.app.v1alpha1.QueryConfigRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryConfigRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.app.v1alpha1.QueryConfigRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_insta_app_v1alpha1_query_proto_init()
	md_QueryConfigResponse = File_insta_app_v1alpha1_query_proto.Messages().ByName("QueryConfigResponse")
...
func (x *QueryConfigResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_app_v1alpha1_query_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryConfigResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.app.v1alpha1.QueryConfigResponse.config":
		return x.Config != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.app.v1alpha1.QueryConfigResponse"))
		}
		panic(fmt.Errorf("message insta.app.v1alpha1.QueryConfigResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryConfigResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.app.v1alpha1.QueryConfigResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryConfigResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.app.v1alpha1.QueryConfigResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func (*QueryConfigRequest) Descriptor() ([]byte, []int) {
	return file_insta_app_v1alpha1_query_proto_rawDescGZIP(), []int{0}
}
...
func (*QueryConfigResponse) Descriptor() ([]byte, []int) {
	return file_insta_app_v1alpha1_query_proto_rawDescGZIP(), []int{1}
}
...
var File_insta_app_v1alpha1_query_proto protoreflect.FileDescriptor

var file_insta_app_v1alpha1_query_proto_rawDesc = []byte{
...
var (
	file_insta_app_v1alpha1_query_proto_rawDescOnce sync.Once
	file_insta_app_v1alpha1_query_proto_rawDescData = file_insta_app_v1alpha1_query_proto_rawDesc
)

func file_insta_app_v1alpha1_query_proto_rawDescGZIP() []byte {
	file_insta_app_v1alpha1_query_proto_rawDescOnce.Do(func() {
		file_insta_app_v1alpha1_query_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_app_v1alpha1_query_proto_rawDescData)
	})
	return file_insta_app_v1alpha1_query_proto_rawDescData
}

var file_insta_app_v1alpha1_query_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_insta_app_v1alpha1_query_proto_goTypes = []interface{}{
	(*QueryConfigRequest)(nil),  // 0: insta.app.v1alpha1.QueryConfigRequest
	(*QueryConfigResponse)(nil), // 1: insta.app.v1alpha1.QueryConfigResponse
	(*Config)(nil),              // 2: insta.app.v1alpha1.Config
}
var file_insta_app_v1alpha1_query_proto_depIdxs = []int32{
	2, // 0: insta.app.v1alpha1.QueryConfigResponse.config:type_name -> insta.app.v1alpha1.Config
	0, // 1: insta.app.v1alpha1.Query.Config:input_type -> insta.app.v1alpha1.QueryConfigRequest
	1, // 2: insta.app.v1alpha1.Query.Config:output_type -> insta.app.v1alpha1.QueryConfigResponse
...
func init() { file_insta_app_v1alpha1_query_proto_init() }
func file_insta_app_v1alpha1_query_proto_init() {
	if File_insta_app_v1alpha1_query_proto != nil {
		return
	}
	file_insta_app_v1alpha1_config_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_insta_app_v1alpha1_query_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_insta_app_v1alpha1_query_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_app_v1alpha1_query_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_insta_app_v1alpha1_query_proto_goTypes,
		DependencyIndexes: file_insta_app_v1alpha1_query_proto_depIdxs,
		MessageInfos:      file_insta_app_v1alpha1_query_proto_msgTypes,
	}.Build()
	File_insta_app_v1alpha1_query_proto = out.File
	file_insta_app_v1alpha1_query_proto_rawDesc = nil
	file_insta_app_v1alpha1_query_proto_goTypes = nil
	file_insta_app_v1alpha1_query_proto_depIdxs = nil
}
