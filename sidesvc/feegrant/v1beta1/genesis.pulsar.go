...
func init() {
	file_insta_feegrant_v1beta1_genesis_proto_init()
	md_GenesisState = File_insta_feegrant_v1beta1_genesis_proto.Messages().ByName("GenesisState")
...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_feegrant_v1beta1_genesis_proto_msgTypes[0]
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.feegrant.v1beta1.GenesisState.allowances":
		return len(x.Allowances) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.feegrant.v1beta1.GenesisState"))
		}
		panic(fmt.Errorf("message insta.feegrant.v1beta1.GenesisState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.feegrant.v1beta1.GenesisState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.feegrant.v1beta1.GenesisState", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: insta/feegrant/v1beta1/genesis.proto
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_insta_feegrant_v1beta1_genesis_proto_rawDescGZIP(), []int{0}
}
...
var File_insta_feegrant_v1beta1_genesis_proto protoreflect.FileDescriptor

var file_insta_feegrant_v1beta1_genesis_proto_rawDesc = []byte{
	...
	0x6e, 0x63, 0x65, 0x73, 0x42, 0xe3, 0x01, 0x0a, 0x1b, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73,
...
var (
	file_insta_feegrant_v1beta1_genesis_proto_rawDescOnce sync.Once
	file_insta_feegrant_v1beta1_genesis_proto_rawDescData = file_insta_feegrant_v1beta1_genesis_proto_rawDesc
)

func file_insta_feegrant_v1beta1_genesis_proto_rawDescGZIP() []byte {
	file_insta_feegrant_v1beta1_genesis_proto_rawDescOnce.Do(func() {
		file_insta_feegrant_v1beta1_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_feegrant_v1beta1_genesis_proto_rawDescData)
	})
	return file_insta_feegrant_v1beta1_genesis_proto_rawDescData
}

var file_insta_feegrant_v1beta1_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_insta_feegrant_v1beta1_genesis_proto_goTypes = []interface{}{
	(*GenesisState)(nil), // 0: insta.feegrant.v1beta1.GenesisState
	(*Grant)(nil),        // 1: insta.feegrant.v1beta1.Grant
}
var file_insta_feegrant_v1beta1_genesis_proto_depIdxs = []int32{
	1, // 0: insta.feegrant.v1beta1.GenesisState.allowances:type_name -> insta.feegrant.v1beta1.Grant
...
func init() { file_insta_feegrant_v1beta1_genesis_proto_init() }
func file_insta_feegrant_v1beta1_genesis_proto_init() {
	if File_insta_feegrant_v1beta1_genesis_proto != nil {
		return
	}
	file_insta_feegrant_v1beta1_feegrant_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_insta_feegrant_v1beta1_genesis_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_feegrant_v1beta1_genesis_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_insta_feegrant_v1beta1_genesis_proto_goTypes,
		DependencyIndexes: file_insta_feegrant_v1beta1_genesis_proto_depIdxs,
		MessageInfos:      file_insta_feegrant_v1beta1_genesis_proto_msgTypes,
	}.Build()
	File_insta_feegrant_v1beta1_genesis_proto = out.File
	file_insta_feegrant_v1beta1_genesis_proto_rawDesc = nil
	file_insta_feegrant_v1beta1_genesis_proto_goTypes = nil
	file_insta_feegrant_v1beta1_genesis_proto_depIdxs = nil
}
