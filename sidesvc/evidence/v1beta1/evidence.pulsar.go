...
func init() {
	file_insta_evidence_v1beta1_evidence_proto_init()
	md_Equivocation = File_insta_evidence_v1beta1_evidence_proto.Messages().ByName("Equivocation")
...
func (x *Equivocation) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_evidence_v1beta1_evidence_proto_msgTypes[0]
...
func (x *fastReflection_Equivocation) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.evidence.v1beta1.Equivocation.height":
		return x.Height != int64(0)
	case "insta.evidence.v1beta1.Equivocation.time":
		return x.Time != nil
	case "insta.evidence.v1beta1.Equivocation.power":
		return x.Power != int64(0)
	case "insta.evidence.v1beta1.Equivocation.consensus_address":
		return x.ConsensusAddress != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.evidence.v1beta1.Equivocation"))
		}
		panic(fmt.Errorf("message insta.evidence.v1beta1.Equivocation does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Equivocation) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.evidence.v1beta1.Equivocation does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Equivocation) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "insta.evidence.v1beta1.Equivocation.height":
		panic(fmt.Errorf("field height of message insta.evidence.v1beta1.Equivocation is not mutable"))
	case "insta.evidence.v1beta1.Equivocation.power":
		panic(fmt.Errorf("field power of message insta.evidence.v1beta1.Equivocation is not mutable"))
	case "insta.evidence.v1beta1.Equivocation.consensus_address":
		panic(fmt.Errorf("field consensus_address of message insta.evidence.v1beta1.Equivocation is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.evidence.v1beta1.Equivocation"))
		}
...
func (x *fastReflection_Equivocation) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.evidence.v1beta1.Equivocation", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: insta/evidence/v1beta1/evidence.proto
...
func (*Equivocation) Descriptor() ([]byte, []int) {
	return file_insta_evidence_v1beta1_evidence_proto_rawDescGZIP(), []int{0}
}
...
var File_insta_evidence_v1beta1_evidence_proto protoreflect.FileDescriptor

var file_insta_evidence_v1beta1_evidence_proto_rawDesc = []byte{
	...
	0x00, 0x42, 0xe8, 0x01, 0x0a, 0x1b, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
	0x2e, 0x65, 0x76, 0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61,
...
var (
	file_insta_evidence_v1beta1_evidence_proto_rawDescOnce sync.Once
	file_insta_evidence_v1beta1_evidence_proto_rawDescData = file_insta_evidence_v1beta1_evidence_proto_rawDesc
)

func file_insta_evidence_v1beta1_evidence_proto_rawDescGZIP() []byte {
	file_insta_evidence_v1beta1_evidence_proto_rawDescOnce.Do(func() {
		file_insta_evidence_v1beta1_evidence_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_evidence_v1beta1_evidence_proto_rawDescData)
	})
	return file_insta_evidence_v1beta1_evidence_proto_rawDescData
}

var file_insta_evidence_v1beta1_evidence_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_insta_evidence_v1beta1_evidence_proto_goTypes = []interface{}{
	(*Equivocation)(nil),          // 0: insta.evidence.v1beta1.Equivocation
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_insta_evidence_v1beta1_evidence_proto_depIdxs = []int32{
	1, // 0: insta.evidence.v1beta1.Equivocation.time:type_name -> google.protobuf.Timestamp
...
func init() { file_insta_evidence_v1beta1_evidence_proto_init() }
func file_insta_evidence_v1beta1_evidence_proto_init() {
	if File_insta_evidence_v1beta1_evidence_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_insta_evidence_v1beta1_evidence_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_evidence_v1beta1_evidence_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_insta_evidence_v1beta1_evidence_proto_goTypes,
		DependencyIndexes: file_insta_evidence_v1beta1_evidence_proto_depIdxs,
		MessageInfos:      file_insta_evidence_v1beta1_evidence_proto_msgTypes,
	}.Build()
	File_insta_evidence_v1beta1_evidence_proto = out.File
	file_insta_evidence_v1beta1_evidence_proto_rawDesc = nil
	file_insta_evidence_v1beta1_evidence_proto_goTypes = nil
	file_insta_evidence_v1beta1_evidence_proto_depIdxs = nil
}
