...
func init() {
	file_insta_bank_v1beta1_authz_proto_init()
	md_SendAuthorization = File_insta_bank_v1beta1_authz_proto.Messages().ByName("SendAuthorization")
...
func (x *SendAuthorization) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_bank_v1beta1_authz_proto_msgTypes[0]
...
func (x *fastReflection_SendAuthorization) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.bank.v1beta1.SendAuthorization.spend_limit":
		return len(x.SpendLimit) != 0
	case "insta.bank.v1beta1.SendAuthorization.allow_list":
		return len(x.AllowList) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.bank.v1beta1.SendAuthorization"))
		}
		panic(fmt.Errorf("message insta.bank.v1beta1.SendAuthorization does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SendAuthorization) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.bank.v1beta1.SendAuthorization does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SendAuthorization) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.bank.v1beta1.SendAuthorization", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: insta/bank/v1beta1/authz.proto
...
func (*SendAuthorization) Descriptor() ([]byte, []int) {
	return file_insta_bank_v1beta1_authz_proto_rawDescGZIP(), []int{0}
}
...
var File_insta_bank_v1beta1_authz_proto protoreflect.FileDescriptor

var file_insta_bank_v1beta1_authz_proto_rawDesc = []byte{
...
var (
	file_insta_bank_v1beta1_authz_proto_rawDescOnce sync.Once
	file_insta_bank_v1beta1_authz_proto_rawDescData = file_insta_bank_v1beta1_authz_proto_rawDesc
)

func file_insta_bank_v1beta1_authz_proto_rawDescGZIP() []byte {
	file_insta_bank_v1beta1_authz_proto_rawDescOnce.Do(func() {
		file_insta_bank_v1beta1_authz_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_bank_v1beta1_authz_proto_rawDescData)
	})
	return file_insta_bank_v1beta1_authz_proto_rawDescData
}

var file_insta_bank_v1beta1_authz_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_insta_bank_v1beta1_authz_proto_goTypes = []interface{}{
	(*SendAuthorization)(nil), // 0: insta.bank.v1beta1.SendAuthorization
	(*v1beta1.Coin)(nil),      // 1: insta.base.v1beta1.Coin
}
var file_insta_bank_v1beta1_authz_proto_depIdxs = []int32{
	1, // 0: insta.bank.v1beta1.SendAuthorization.spend_limit:type_name -> insta.base.v1beta1.Coin
...
func init() { file_insta_bank_v1beta1_authz_proto_init() }
func file_insta_bank_v1beta1_authz_proto_init() {
	if File_insta_bank_v1beta1_authz_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_insta_bank_v1beta1_authz_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_bank_v1beta1_authz_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_insta_bank_v1beta1_authz_proto_goTypes,
		DependencyIndexes: file_insta_bank_v1beta1_authz_proto_depIdxs,
		MessageInfos:      file_insta_bank_v1beta1_authz_proto_msgTypes,
	}.Build()
	File_insta_bank_v1beta1_authz_proto = out.File
	file_insta_bank_v1beta1_authz_proto_rawDesc = nil
	file_insta_bank_v1beta1_authz_proto_goTypes = nil
	file_insta_bank_v1beta1_authz_proto_depIdxs = nil
}
