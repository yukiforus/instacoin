...
func init() {
	file_insta_crypto_hd_v1_hd_proto_init()
	md_BIP44Params = File_insta_crypto_hd_v1_hd_proto.Messages().ByName("BIP44Params")
...
func (x *BIP44Params) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_crypto_hd_v1_hd_proto_msgTypes[0]
...
func (x *fastReflection_BIP44Params) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.crypto.hd.v1.BIP44Params.purpose":
		return x.Purpose != uint32(0)
	case "insta.crypto.hd.v1.BIP44Params.coin_type":
		return x.CoinType != uint32(0)
	case "insta.crypto.hd.v1.BIP44Params.account":
		return x.Account != uint32(0)
	case "insta.crypto.hd.v1.BIP44Params.change":
		return x.Change != false
	case "insta.crypto.hd.v1.BIP44Params.address_index":
		return x.AddressIndex != uint32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.crypto.hd.v1.BIP44Params"))
		}
		panic(fmt.Errorf("message insta.crypto.hd.v1.BIP44Params does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BIP44Params) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.crypto.hd.v1.BIP44Params does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BIP44Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "insta.crypto.hd.v1.BIP44Params.purpose":
		panic(fmt.Errorf("field purpose of message insta.crypto.hd.v1.BIP44Params is not mutable"))
	case "insta.crypto.hd.v1.BIP44Params.coin_type":
		panic(fmt.Errorf("field coin_type of message insta.crypto.hd.v1.BIP44Params is not mutable"))
	case "insta.crypto.hd.v1.BIP44Params.account":
		panic(fmt.Errorf("field account of message insta.crypto.hd.v1.BIP44Params is not mutable"))
	case "insta.crypto.hd.v1.BIP44Params.change":
		panic(fmt.Errorf("field change of message insta.crypto.hd.v1.BIP44Params is not mutable"))
	case "insta.crypto.hd.v1.BIP44Params.address_index":
		panic(fmt.Errorf("field address_index of message insta.crypto.hd.v1.BIP44Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.crypto.hd.v1.BIP44Params"))
		}
...
func (x *fastReflection_BIP44Params) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.crypto.hd.v1.BIP44Params", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: insta/crypto/hd/v1/hd.proto
...
func (*BIP44Params) Descriptor() ([]byte, []int) {
	return file_insta_crypto_hd_v1_hd_proto_rawDescGZIP(), []int{0}
}
...
var File_insta_crypto_hd_v1_hd_proto protoreflect.FileDescriptor

var file_insta_crypto_hd_v1_hd_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x3a, 0x04, 0x98, 0xa0, 0x1f, 0x00, 0x42, 0xc0, 0x01,
	...
	0x69, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x63, 0x72,
...
var (
	file_insta_crypto_hd_v1_hd_proto_rawDescOnce sync.Once
	file_insta_crypto_hd_v1_hd_proto_rawDescData = file_insta_crypto_hd_v1_hd_proto_rawDesc
)

func file_insta_crypto_hd_v1_hd_proto_rawDescGZIP() []byte {
	file_insta_crypto_hd_v1_hd_proto_rawDescOnce.Do(func() {
		file_insta_crypto_hd_v1_hd_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_crypto_hd_v1_hd_proto_rawDescData)
	})
	return file_insta_crypto_hd_v1_hd_proto_rawDescData
}

var file_insta_crypto_hd_v1_hd_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_insta_crypto_hd_v1_hd_proto_goTypes = []interface{}{
	(*BIP44Params)(nil), // 0: insta.crypto.hd.v1.BIP44Params
}
var file_insta_crypto_hd_v1_hd_proto_depIdxs = []int32{
...
func init() { file_insta_crypto_hd_v1_hd_proto_init() }
func file_insta_crypto_hd_v1_hd_proto_init() {
	if File_insta_crypto_hd_v1_hd_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_insta_crypto_hd_v1_hd_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_crypto_hd_v1_hd_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_insta_crypto_hd_v1_hd_proto_goTypes,
		DependencyIndexes: file_insta_crypto_hd_v1_hd_proto_depIdxs,
		MessageInfos:      file_insta_crypto_hd_v1_hd_proto_msgTypes,
	}.Build()
	File_insta_crypto_hd_v1_hd_proto = out.File
	file_insta_crypto_hd_v1_hd_proto_rawDesc = nil
	file_insta_crypto_hd_v1_hd_proto_goTypes = nil
	file_insta_crypto_hd_v1_hd_proto_depIdxs = nil
}
