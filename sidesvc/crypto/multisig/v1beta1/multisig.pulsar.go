...
func init() {
	file_insta_crypto_multisig_v1beta1_multisig_proto_init()
	md_MultiSignature = File_insta_crypto_multisig_v1beta1_multisig_proto.Messages().ByName("MultiSignature")
...
func (x *MultiSignature) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_crypto_multisig_v1beta1_multisig_proto_msgTypes[0]
...
func (x *fastReflection_MultiSignature) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.crypto.multisig.v1beta1.MultiSignature.signatures":
		return len(x.Signatures) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.crypto.multisig.v1beta1.MultiSignature"))
		}
		panic(fmt.Errorf("message insta.crypto.multisig.v1beta1.MultiSignature does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MultiSignature) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.crypto.multisig.v1beta1.MultiSignature does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MultiSignature) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.crypto.multisig.v1beta1.MultiSignature", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_insta_crypto_multisig_v1beta1_multisig_proto_init()
	md_CompactBitArray = File_insta_crypto_multisig_v1beta1_multisig_proto.Messages().ByName("CompactBitArray")
...
func (x *CompactBitArray) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_crypto_multisig_v1beta1_multisig_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_CompactBitArray) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.crypto.multisig.v1beta1.CompactBitArray.extra_bits_stored":
		return x.ExtraBitsStored != uint32(0)
	case "insta.crypto.multisig.v1beta1.CompactBitArray.elems":
		return len(x.Elems) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.crypto.multisig.v1beta1.CompactBitArray"))
		}
		panic(fmt.Errorf("message insta.crypto.multisig.v1beta1.CompactBitArray does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CompactBitArray) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.crypto.multisig.v1beta1.CompactBitArray does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CompactBitArray) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "insta.crypto.multisig.v1beta1.CompactBitArray.extra_bits_stored":
		panic(fmt.Errorf("field extra_bits_stored of message insta.crypto.multisig.v1beta1.CompactBitArray is not mutable"))
	case "insta.crypto.multisig.v1beta1.CompactBitArray.elems":
		panic(fmt.Errorf("field elems of message insta.crypto.multisig.v1beta1.CompactBitArray is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.crypto.multisig.v1beta1.CompactBitArray"))
		}
...
func (x *fastReflection_CompactBitArray) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.crypto.multisig.v1beta1.CompactBitArray", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: insta/crypto/multisig/v1beta1/multisig.proto
...
// See insta.tx.v1betata1.ModeInfo.Multi for how to specify which signers
...
func (*MultiSignature) Descriptor() ([]byte, []int) {
	return file_insta_crypto_multisig_v1beta1_multisig_proto_rawDescGZIP(), []int{0}
}
...
func (*CompactBitArray) Descriptor() ([]byte, []int) {
	return file_insta_crypto_multisig_v1beta1_multisig_proto_rawDescGZIP(), []int{1}
}
...
var File_insta_crypto_multisig_v1beta1_multisig_proto protoreflect.FileDescriptor

var file_insta_crypto_multisig_v1beta1_multisig_proto_rawDesc = []byte{
...
var (
	file_insta_crypto_multisig_v1beta1_multisig_proto_rawDescOnce sync.Once
	file_insta_crypto_multisig_v1beta1_multisig_proto_rawDescData = file_insta_crypto_multisig_v1beta1_multisig_proto_rawDesc
)

func file_insta_crypto_multisig_v1beta1_multisig_proto_rawDescGZIP() []byte {
	file_insta_crypto_multisig_v1beta1_multisig_proto_rawDescOnce.Do(func() {
		file_insta_crypto_multisig_v1beta1_multisig_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_crypto_multisig_v1beta1_multisig_proto_rawDescData)
	})
	return file_insta_crypto_multisig_v1beta1_multisig_proto_rawDescData
}

var file_insta_crypto_multisig_v1beta1_multisig_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_insta_crypto_multisig_v1beta1_multisig_proto_goTypes = []interface{}{
	(*MultiSignature)(nil),  // 0: insta.crypto.multisig.v1beta1.MultiSignature
	(*CompactBitArray)(nil), // 1: insta.crypto.multisig.v1beta1.CompactBitArray
}
var file_insta_crypto_multisig_v1beta1_multisig_proto_depIdxs = []int32{
...
func init() { file_insta_crypto_multisig_v1beta1_multisig_proto_init() }
func file_insta_crypto_multisig_v1beta1_multisig_proto_init() {
	if File_insta_crypto_multisig_v1beta1_multisig_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_insta_crypto_multisig_v1beta1_multisig_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_insta_crypto_multisig_v1beta1_multisig_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_crypto_multisig_v1beta1_multisig_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_insta_crypto_multisig_v1beta1_multisig_proto_goTypes,
		DependencyIndexes: file_insta_crypto_multisig_v1beta1_multisig_proto_depIdxs,
		MessageInfos:      file_insta_crypto_multisig_v1beta1_multisig_proto_msgTypes,
	}.Build()
	File_insta_crypto_multisig_v1beta1_multisig_proto = out.File
	file_insta_crypto_multisig_v1beta1_multisig_proto_rawDesc = nil
	file_insta_crypto_multisig_v1beta1_multisig_proto_goTypes = nil
	file_insta_crypto_multisig_v1beta1_multisig_proto_depIdxs = nil
}
