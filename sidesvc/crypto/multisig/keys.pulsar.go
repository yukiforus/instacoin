...
func init() {
	file_insta_crypto_multisig_keys_proto_init()
	md_LegacyAminoPubKey = File_insta_crypto_multisig_keys_proto.Messages().ByName("LegacyAminoPubKey")
...
func (x *LegacyAminoPubKey) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_crypto_multisig_keys_proto_msgTypes[0]
...
func (x *fastReflection_LegacyAminoPubKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.crypto.multisig.LegacyAminoPubKey.threshold":
		return x.Threshold != uint32(0)
	case "insta.crypto.multisig.LegacyAminoPubKey.public_keys":
		return len(x.PublicKeys) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.crypto.multisig.LegacyAminoPubKey"))
		}
		panic(fmt.Errorf("message insta.crypto.multisig.LegacyAminoPubKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_LegacyAminoPubKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.crypto.multisig.LegacyAminoPubKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_LegacyAminoPubKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "insta.crypto.multisig.LegacyAminoPubKey.threshold":
		panic(fmt.Errorf("field threshold of message insta.crypto.multisig.LegacyAminoPubKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.crypto.multisig.LegacyAminoPubKey"))
		}
...
func (x *fastReflection_LegacyAminoPubKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.crypto.multisig.LegacyAminoPubKey", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: insta/crypto/multisig/keys.proto
...
func (*LegacyAminoPubKey) Descriptor() ([]byte, []int) {
	return file_insta_crypto_multisig_keys_proto_rawDescGZIP(), []int{0}
}
...
var File_insta_crypto_multisig_keys_proto protoreflect.FileDescriptor

var file_insta_crypto_multisig_keys_proto_rawDesc = []byte{
...
var (
	file_insta_crypto_multisig_keys_proto_rawDescOnce sync.Once
	file_insta_crypto_multisig_keys_proto_rawDescData = file_insta_crypto_multisig_keys_proto_rawDesc
)

func file_insta_crypto_multisig_keys_proto_rawDescGZIP() []byte {
	file_insta_crypto_multisig_keys_proto_rawDescOnce.Do(func() {
		file_insta_crypto_multisig_keys_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_crypto_multisig_keys_proto_rawDescData)
	})
	return file_insta_crypto_multisig_keys_proto_rawDescData
}

var file_insta_crypto_multisig_keys_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_insta_crypto_multisig_keys_proto_goTypes = []interface{}{
	(*LegacyAminoPubKey)(nil), // 0: insta.crypto.multisig.LegacyAminoPubKey
	(*anypb.Any)(nil),         // 1: google.protobuf.Any
}
var file_insta_crypto_multisig_keys_proto_depIdxs = []int32{
	1, // 0: insta.crypto.multisig.LegacyAminoPubKey.public_keys:type_name -> google.protobuf.Any
...
func init() { file_insta_crypto_multisig_keys_proto_init() }
func file_insta_crypto_multisig_keys_proto_init() {
	if File_insta_crypto_multisig_keys_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_insta_crypto_multisig_keys_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_crypto_multisig_keys_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_insta_crypto_multisig_keys_proto_goTypes,
		DependencyIndexes: file_insta_crypto_multisig_keys_proto_depIdxs,
		MessageInfos:      file_insta_crypto_multisig_keys_proto_msgTypes,
	}.Build()
	File_insta_crypto_multisig_keys_proto = out.File
	file_insta_crypto_multisig_keys_proto_rawDesc = nil
	file_insta_crypto_multisig_keys_proto_goTypes = nil
	file_insta_crypto_multisig_keys_proto_depIdxs = nil
}
