...
func init() {
	file_insta_vesting_module_v1_module_proto_init()
	md_Module = File_insta_vesting_module_v1_module_proto.Messages().ByName("Module")
}
...
func (x *Module) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_vesting_module_v1_module_proto_msgTypes[0]
...
func (x *fastReflection_Module) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.vesting.module.v1.Module"))
		}
		panic(fmt.Errorf("message insta.vesting.module.v1.Module does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Module) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.vesting.module.v1.Module does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Module) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.vesting.module.v1.Module", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: insta/vesting/module/v1/module.proto
...
func (*Module) Descriptor() ([]byte, []int) {
	return file_insta_vesting_module_v1_module_proto_rawDescGZIP(), []int{0}
}

var File_insta_vesting_module_v1_module_proto protoreflect.FileDescriptor

var file_insta_vesting_module_v1_module_proto_rawDesc = []byte{
...
var (
	file_insta_vesting_module_v1_module_proto_rawDescOnce sync.Once
	file_insta_vesting_module_v1_module_proto_rawDescData = file_insta_vesting_module_v1_module_proto_rawDesc
)

func file_insta_vesting_module_v1_module_proto_rawDescGZIP() []byte {
	file_insta_vesting_module_v1_module_proto_rawDescOnce.Do(func() {
		file_insta_vesting_module_v1_module_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_vesting_module_v1_module_proto_rawDescData)
	})
	return file_insta_vesting_module_v1_module_proto_rawDescData
}

var file_insta_vesting_module_v1_module_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_insta_vesting_module_v1_module_proto_goTypes = []interface{}{
	(*Module)(nil), // 0: insta.vesting.module.v1.Module
}
var file_insta_vesting_module_v1_module_proto_depIdxs = []int32{
...
func init() { file_insta_vesting_module_v1_module_proto_init() }
func file_insta_vesting_module_v1_module_proto_init() {
	if File_insta_vesting_module_v1_module_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_insta_vesting_module_v1_module_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Module); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_vesting_module_v1_module_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_insta_vesting_module_v1_module_proto_goTypes,
		DependencyIndexes: file_insta_vesting_module_v1_module_proto_depIdxs,
		MessageInfos:      file_insta_vesting_module_v1_module_proto_msgTypes,
	}.Build()
	File_insta_vesting_module_v1_module_proto = out.File
	file_insta_vesting_module_v1_module_proto_rawDesc = nil
	file_insta_vesting_module_v1_module_proto_goTypes = nil
	file_insta_vesting_module_v1_module_proto_depIdxs = nil
}
