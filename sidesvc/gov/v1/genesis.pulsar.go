...
func init() {
	file_insta_gov_v1_genesis_proto_init()
	md_GenesisState = File_insta_gov_v1_genesis_proto.Messages().ByName("GenesisState")
...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_gov_v1_genesis_proto_msgTypes[0]
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.gov.v1.GenesisState.starting_proposal_id":
		return x.StartingProposalId != uint64(0)
	case "insta.gov.v1.GenesisState.deposits":
		return len(x.Deposits) != 0
	case "insta.gov.v1.GenesisState.votes":
		return len(x.Votes) != 0
	case "insta.gov.v1.GenesisState.proposals":
		return len(x.Proposals) != 0
	case "insta.gov.v1.GenesisState.deposit_params":
		return x.DepositParams != nil
	case "insta.gov.v1.GenesisState.voting_params":
		return x.VotingParams != nil
	case "insta.gov.v1.GenesisState.tally_params":
		return x.TallyParams != nil
	case "insta.gov.v1.GenesisState.params":
		return x.Params != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.gov.v1.GenesisState"))
		}
		panic(fmt.Errorf("message insta.gov.v1.GenesisState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.gov.v1.GenesisState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "insta.gov.v1.GenesisState.starting_proposal_id":
		panic(fmt.Errorf("field starting_proposal_id of message insta.gov.v1.GenesisState is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.gov.v1.GenesisState"))
		}
...
func (x *fastReflection_GenesisState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.gov.v1.GenesisState", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: insta/gov/v1/genesis.proto
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_insta_gov_v1_genesis_proto_rawDescGZIP(), []int{0}
}
...
var File_insta_gov_v1_genesis_proto protoreflect.FileDescriptor

var file_insta_gov_v1_genesis_proto_rawDesc = []byte{
...
var (
	file_insta_gov_v1_genesis_proto_rawDescOnce sync.Once
	file_insta_gov_v1_genesis_proto_rawDescData = file_insta_gov_v1_genesis_proto_rawDesc
)

func file_insta_gov_v1_genesis_proto_rawDescGZIP() []byte {
	file_insta_gov_v1_genesis_proto_rawDescOnce.Do(func() {
		file_insta_gov_v1_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_gov_v1_genesis_proto_rawDescData)
	})
	return file_insta_gov_v1_genesis_proto_rawDescData
}

var file_insta_gov_v1_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_insta_gov_v1_genesis_proto_goTypes = []interface{}{
	(*GenesisState)(nil),  // 0: insta.gov.v1.GenesisState
	(*Deposit)(nil),       // 1: insta.gov.v1.Deposit
	(*Vote)(nil),          // 2: insta.gov.v1.Vote
	(*Proposal)(nil),      // 3: insta.gov.v1.Proposal
	(*DepositParams)(nil), // 4: insta.gov.v1.DepositParams
	(*VotingParams)(nil),  // 5: insta.gov.v1.VotingParams
	(*TallyParams)(nil),   // 6: insta.gov.v1.TallyParams
	(*Params)(nil),        // 7: insta.gov.v1.Params
}
var file_insta_gov_v1_genesis_proto_depIdxs = []int32{
	1, // 0: insta.gov.v1.GenesisState.deposits:type_name -> insta.gov.v1.Deposit
	2, // 1: insta.gov.v1.GenesisState.votes:type_name -> insta.gov.v1.Vote
	3, // 2: insta.gov.v1.GenesisState.proposals:type_name -> insta.gov.v1.Proposal
	4, // 3: insta.gov.v1.GenesisState.deposit_params:type_name -> insta.gov.v1.DepositParams
	5, // 4: insta.gov.v1.GenesisState.voting_params:type_name -> insta.gov.v1.VotingParams
	6, // 5: insta.gov.v1.GenesisState.tally_params:type_name -> insta.gov.v1.TallyParams
	7, // 6: insta.gov.v1.GenesisState.params:type_name -> insta.gov.v1.Params
...
func init() { file_insta_gov_v1_genesis_proto_init() }
func file_insta_gov_v1_genesis_proto_init() {
	if File_insta_gov_v1_genesis_proto != nil {
		return
	}
	file_insta_gov_v1_gov_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_insta_gov_v1_genesis_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_gov_v1_genesis_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_insta_gov_v1_genesis_proto_goTypes,
		DependencyIndexes: file_insta_gov_v1_genesis_proto_depIdxs,
		MessageInfos:      file_insta_gov_v1_genesis_proto_msgTypes,
	}.Build()
	File_insta_gov_v1_genesis_proto = out.File
	file_insta_gov_v1_genesis_proto_rawDesc = nil
	file_insta_gov_v1_genesis_proto_goTypes = nil
	file_insta_gov_v1_genesis_proto_depIdxs = nil
}
