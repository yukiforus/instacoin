...
func init() {
	file_insta_base_store_v1beta1_listening_proto_init()
	md_StoreKVPair = File_insta_base_store_v1beta1_listening_proto.Messages().ByName("StoreKVPair")
...
func (x *StoreKVPair) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_base_store_v1beta1_listening_proto_msgTypes[0]
...
func (x *fastReflection_StoreKVPair) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.base.store.v1beta1.StoreKVPair.store_key":
		return x.StoreKey != ""
	case "insta.base.store.v1beta1.StoreKVPair.delete":
		return x.Delete != false
	case "insta.base.store.v1beta1.StoreKVPair.key":
		return len(x.Key) != 0
	case "insta.base.store.v1beta1.StoreKVPair.value":
		return len(x.Value) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.base.store.v1beta1.StoreKVPair"))
		}
		panic(fmt.Errorf("message insta.base.store.v1beta1.StoreKVPair does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_StoreKVPair) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.base.store.v1beta1.StoreKVPair does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_StoreKVPair) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "insta.base.store.v1beta1.StoreKVPair.store_key":
		panic(fmt.Errorf("field store_key of message insta.base.store.v1beta1.StoreKVPair is not mutable"))
	case "insta.base.store.v1beta1.StoreKVPair.delete":
		panic(fmt.Errorf("field delete of message insta.base.store.v1beta1.StoreKVPair is not mutable"))
	case "insta.base.store.v1beta1.StoreKVPair.key":
		panic(fmt.Errorf("field key of message insta.base.store.v1beta1.StoreKVPair is not mutable"))
	case "insta.base.store.v1beta1.StoreKVPair.value":
		panic(fmt.Errorf("field value of message insta.base.store.v1beta1.StoreKVPair is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.base.store.v1beta1.StoreKVPair"))
		}
...
func (x *fastReflection_StoreKVPair) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.base.store.v1beta1.StoreKVPair", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: insta/base/store/v1beta1/listening.proto
...
func (*StoreKVPair) Descriptor() ([]byte, []int) {
	return file_insta_base_store_v1beta1_listening_proto_rawDescGZIP(), []int{0}
}
...
var File_insta_base_store_v1beta1_listening_proto protoreflect.FileDescriptor

var file_insta_base_store_v1beta1_listening_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x42, 0xef, 0x01, 0x0a, 0x1d, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f,
	...
	0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x37, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x73, 0x64,
...
var (
	file_insta_base_store_v1beta1_listening_proto_rawDescOnce sync.Once
	file_insta_base_store_v1beta1_listening_proto_rawDescData = file_insta_base_store_v1beta1_listening_proto_rawDesc
)

func file_insta_base_store_v1beta1_listening_proto_rawDescGZIP() []byte {
	file_insta_base_store_v1beta1_listening_proto_rawDescOnce.Do(func() {
		file_insta_base_store_v1beta1_listening_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_base_store_v1beta1_listening_proto_rawDescData)
	})
	return file_insta_base_store_v1beta1_listening_proto_rawDescData
}

var file_insta_base_store_v1beta1_listening_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_insta_base_store_v1beta1_listening_proto_goTypes = []interface{}{
	(*StoreKVPair)(nil), // 0: insta.base.store.v1beta1.StoreKVPair
}
var file_insta_base_store_v1beta1_listening_proto_depIdxs = []int32{
...
func init() { file_insta_base_store_v1beta1_listening_proto_init() }
func file_insta_base_store_v1beta1_listening_proto_init() {
	if File_insta_base_store_v1beta1_listening_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_insta_base_store_v1beta1_listening_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_base_store_v1beta1_listening_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_insta_base_store_v1beta1_listening_proto_goTypes,
		DependencyIndexes: file_insta_base_store_v1beta1_listening_proto_depIdxs,
		MessageInfos:      file_insta_base_store_v1beta1_listening_proto_msgTypes,
	}.Build()
	File_insta_base_store_v1beta1_listening_proto = out.File
	file_insta_base_store_v1beta1_listening_proto_rawDesc = nil
	file_insta_base_store_v1beta1_listening_proto_goTypes = nil
	file_insta_base_store_v1beta1_listening_proto_depIdxs = nil
}
