...
func init() {
	file_insta_base_query_v1beta1_pagination_proto_init()
	md_PageRequest = File_insta_base_query_v1beta1_pagination_proto.Messages().ByName("PageRequest")
...
func (x *PageRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_base_query_v1beta1_pagination_proto_msgTypes[0]
...
func (x *fastReflection_PageRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.base.query.v1beta1.PageRequest.key":
		return len(x.Key) != 0
	case "insta.base.query.v1beta1.PageRequest.offset":
		return x.Offset != uint64(0)
	case "insta.base.query.v1beta1.PageRequest.limit":
		return x.Limit != uint64(0)
	case "insta.base.query.v1beta1.PageRequest.count_total":
		return x.CountTotal != false
	case "insta.base.query.v1beta1.PageRequest.reverse":
		return x.Reverse != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.base.query.v1beta1.PageRequest"))
		}
		panic(fmt.Errorf("message insta.base.query.v1beta1.PageRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PageRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.base.query.v1beta1.PageRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PageRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "insta.base.query.v1beta1.PageRequest.key":
		panic(fmt.Errorf("field key of message insta.base.query.v1beta1.PageRequest is not mutable"))
	case "insta.base.query.v1beta1.PageRequest.offset":
		panic(fmt.Errorf("field offset of message insta.base.query.v1beta1.PageRequest is not mutable"))
	case "insta.base.query.v1beta1.PageRequest.limit":
		panic(fmt.Errorf("field limit of message insta.base.query.v1beta1.PageRequest is not mutable"))
	case "insta.base.query.v1beta1.PageRequest.count_total":
		panic(fmt.Errorf("field count_total of message insta.base.query.v1beta1.PageRequest is not mutable"))
	case "insta.base.query.v1beta1.PageRequest.reverse":
		panic(fmt.Errorf("field reverse of message insta.base.query.v1beta1.PageRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.base.query.v1beta1.PageRequest"))
		}
...
func (x *fastReflection_PageRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.base.query.v1beta1.PageRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_insta_base_query_v1beta1_pagination_proto_init()
	md_PageResponse = File_insta_base_query_v1beta1_pagination_proto.Messages().ByName("PageResponse")
...
func (x *PageResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_base_query_v1beta1_pagination_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_PageResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.base.query.v1beta1.PageResponse.next_key":
		return len(x.NextKey) != 0
	case "insta.base.query.v1beta1.PageResponse.total":
		return x.Total != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.base.query.v1beta1.PageResponse"))
		}
		panic(fmt.Errorf("message insta.base.query.v1beta1.PageResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PageResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.base.query.v1beta1.PageResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PageResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "insta.base.query.v1beta1.PageResponse.next_key":
		panic(fmt.Errorf("field next_key of message insta.base.query.v1beta1.PageResponse is not mutable"))
	case "insta.base.query.v1beta1.PageResponse.total":
		panic(fmt.Errorf("field total of message insta.base.query.v1beta1.PageResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.base.query.v1beta1.PageResponse"))
		}
...
func (x *fastReflection_PageResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.base.query.v1beta1.PageResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: insta/base/query/v1beta1/pagination.proto
...
func (*PageRequest) Descriptor() ([]byte, []int) {
	return file_insta_base_query_v1beta1_pagination_proto_rawDescGZIP(), []int{0}
}
...
func (*PageResponse) Descriptor() ([]byte, []int) {
	return file_insta_base_query_v1beta1_pagination_proto_rawDescGZIP(), []int{1}
}
...
var File_insta_base_query_v1beta1_pagination_proto protoreflect.FileDescriptor

var file_insta_base_query_v1beta1_pagination_proto_rawDesc = []byte{
...
var (
	file_insta_base_query_v1beta1_pagination_proto_rawDescOnce sync.Once
	file_insta_base_query_v1beta1_pagination_proto_rawDescData = file_insta_base_query_v1beta1_pagination_proto_rawDesc
)

func file_insta_base_query_v1beta1_pagination_proto_rawDescGZIP() []byte {
	file_insta_base_query_v1beta1_pagination_proto_rawDescOnce.Do(func() {
		file_insta_base_query_v1beta1_pagination_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_base_query_v1beta1_pagination_proto_rawDescData)
	})
	return file_insta_base_query_v1beta1_pagination_proto_rawDescData
}

var file_insta_base_query_v1beta1_pagination_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_insta_base_query_v1beta1_pagination_proto_goTypes = []interface{}{
	(*PageRequest)(nil),  // 0: insta.base.query.v1beta1.PageRequest
	(*PageResponse)(nil), // 1: insta.base.query.v1beta1.PageResponse
}
var file_insta_base_query_v1beta1_pagination_proto_depIdxs = []int32{
...
func init() { file_insta_base_query_v1beta1_pagination_proto_init() }
func file_insta_base_query_v1beta1_pagination_proto_init() {
	if File_insta_base_query_v1beta1_pagination_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_insta_base_query_v1beta1_pagination_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_insta_base_query_v1beta1_pagination_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_base_query_v1beta1_pagination_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_insta_base_query_v1beta1_pagination_proto_goTypes,
		DependencyIndexes: file_insta_base_query_v1beta1_pagination_proto_depIdxs,
		MessageInfos:      file_insta_base_query_v1beta1_pagination_proto_msgTypes,
	}.Build()
	File_insta_base_query_v1beta1_pagination_proto = out.File
	file_insta_base_query_v1beta1_pagination_proto_rawDesc = nil
	file_insta_base_query_v1beta1_pagination_proto_goTypes = nil
	file_insta_base_query_v1beta1_pagination_proto_depIdxs = nil
}
