...
func init() {
	...
	md_Class = File_insta_nft_v1beta1_nft_proto.Messages().ByName("Class")
...
func (x *Class) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_nft_v1beta1_nft_proto_msgTypes[0]
...
func (x *fastReflection_Class) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.nft.v1beta1.Class.id":
		return x.Id != ""
	case "insta.nft.v1beta1.Class.name":
		return x.Name != ""
	case "insta.nft.v1beta1.Class.symbol":
		return x.Symbol != ""
	case "insta.nft.v1beta1.Class.description":
		return x.Description != ""
	case "insta.nft.v1beta1.Class.uri":
		return x.Uri != ""
	case "insta.nft.v1beta1.Class.uri_hash":
		return x.UriHash != ""
	case "insta.nft.v1beta1.Class.data":
		return x.Data != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.nft.v1beta1.Class"))
		}
		panic(fmt.Errorf("message insta.nft.v1beta1.Class does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Class) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.nft.v1beta1.Class does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Class) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "insta.nft.v1beta1.Class.id":
		panic(fmt.Errorf("field id of message insta.nft.v1beta1.Class is not mutable"))
	case "insta.nft.v1beta1.Class.name":
		panic(fmt.Errorf("field name of message insta.nft.v1beta1.Class is not mutable"))
	case "insta.nft.v1beta1.Class.symbol":
		panic(fmt.Errorf("field symbol of message insta.nft.v1beta1.Class is not mutable"))
	case "insta.nft.v1beta1.Class.description":
		panic(fmt.Errorf("field description of message insta.nft.v1beta1.Class is not mutable"))
	case "insta.nft.v1beta1.Class.uri":
		panic(fmt.Errorf("field uri of message insta.nft.v1beta1.Class is not mutable"))
	case "insta.nft.v1beta1.Class.uri_hash":
		panic(fmt.Errorf("field uri_hash of message insta.nft.v1beta1.Class is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.nft.v1beta1.Class"))
		}
...
func (x *fastReflection_Class) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.nft.v1beta1.Class", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_insta_nft_v1beta1_nft_proto_init()
	md_NFT = File_insta_nft_v1beta1_nft_proto.Messages().ByName("NFT")
...
func (x *NFT) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_nft_v1beta1_nft_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_NFT) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.nft.v1beta1.NFT.class_id":
		return x.ClassId != ""
	case "insta.nft.v1beta1.NFT.id":
		return x.Id != ""
	case "insta.nft.v1beta1.NFT.uri":
		return x.Uri != ""
	case "insta.nft.v1beta1.NFT.uri_hash":
		return x.UriHash != ""
	case "insta.nft.v1beta1.NFT.data":
		return x.Data != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.nft.v1beta1.NFT"))
		}
		panic(fmt.Errorf("message insta.nft.v1beta1.NFT does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_NFT) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.nft.v1beta1.NFT does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_NFT) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "insta.nft.v1beta1.NFT.data":
		...
		return protoreflect.ValueOfMessage(x.Data.ProtoReflect())
	case "insta.nft.v1beta1.NFT.class_id":
		panic(fmt.Errorf("field class_id of message insta.nft.v1beta1.NFT is not mutable"))
	case "insta.nft.v1beta1.NFT.id":
		panic(fmt.Errorf("field id of message insta.nft.v1beta1.NFT is not mutable"))
	case "insta.nft.v1beta1.NFT.uri":
		panic(fmt.Errorf("field uri of message insta.nft.v1beta1.NFT is not mutable"))
	case "insta.nft.v1beta1.NFT.uri_hash":
		panic(fmt.Errorf("field uri_hash of message insta.nft.v1beta1.NFT is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.nft.v1beta1.NFT"))
		}
...
func (x *fastReflection_NFT) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.nft.v1beta1.NFT", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: insta/nft/v1beta1/nft.proto
...
func (*Class) Descriptor() ([]byte, []int) {
	return file_insta_nft_v1beta1_nft_proto_rawDescGZIP(), []int{0}
}
...
func (*NFT) Descriptor() ([]byte, []int) {
	return file_insta_nft_v1beta1_nft_proto_rawDescGZIP(), []int{1}
}
...
var File_insta_nft_v1beta1_nft_proto protoreflect.FileDescriptor

var file_insta_nft_v1beta1_nft_proto_rawDesc = []byte{
...
var (
	file_insta_nft_v1beta1_nft_proto_rawDescOnce sync.Once
	file_insta_nft_v1beta1_nft_proto_rawDescData = file_insta_nft_v1beta1_nft_proto_rawDesc
)

func file_insta_nft_v1beta1_nft_proto_rawDescGZIP() []byte {
	file_insta_nft_v1beta1_nft_proto_rawDescOnce.Do(func() {
		file_insta_nft_v1beta1_nft_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_nft_v1beta1_nft_proto_rawDescData)
	})
	return file_insta_nft_v1beta1_nft_proto_rawDescData
}

var file_insta_nft_v1beta1_nft_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_insta_nft_v1beta1_nft_proto_goTypes = []interface{}{
	(*Class)(nil),     // 0: insta.nft.v1beta1.Class
	(*NFT)(nil),       // 1: insta.nft.v1beta1.NFT
	(*anypb.Any)(nil), // 2: google.protobuf.Any
}
var file_insta_nft_v1beta1_nft_proto_depIdxs = []int32{
	2, // 0: insta.nft.v1beta1.Class.data:type_name -> google.protobuf.Any
	2, // 1: insta.nft.v1beta1.NFT.data:type_name -> google.protobuf.Any
...
func init() { file_insta_nft_v1beta1_nft_proto_init() }
func file_insta_nft_v1beta1_nft_proto_init() {
	if File_insta_nft_v1beta1_nft_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_insta_nft_v1beta1_nft_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Class); i {
			case 0:
				return &v.state
			case 1:
		...
		file_insta_nft_v1beta1_nft_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NFT); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_nft_v1beta1_nft_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_insta_nft_v1beta1_nft_proto_goTypes,
		DependencyIndexes: file_insta_nft_v1beta1_nft_proto_depIdxs,
		MessageInfos:      file_insta_nft_v1beta1_nft_proto_msgTypes,
	}.Build()
	File_insta_nft_v1beta1_nft_proto = out.File
	file_insta_nft_v1beta1_nft_proto_rawDesc = nil
	file_insta_nft_v1beta1_nft_proto_goTypes = nil
	file_insta_nft_v1beta1_nft_proto_depIdxs = nil
}
