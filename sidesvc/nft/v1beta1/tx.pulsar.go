...
func init() {
	file_insta_nft_v1beta1_tx_proto_init()
	md_MsgSend = File_insta_nft_v1beta1_tx_proto.Messages().ByName("MsgSend")
...
func (x *MsgSend) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_nft_v1beta1_tx_proto_msgTypes[0]
...
func (x *fastReflection_MsgSend) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.nft.v1beta1.MsgSend.class_id":
		return x.ClassId != ""
	case "insta.nft.v1beta1.MsgSend.id":
		return x.Id != ""
	case "insta.nft.v1beta1.MsgSend.sender":
		return x.Sender != ""
	case "insta.nft.v1beta1.MsgSend.receiver":
		return x.Receiver != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.nft.v1beta1.MsgSend"))
		}
		panic(fmt.Errorf("message insta.nft.v1beta1.MsgSend does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgSend) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.nft.v1beta1.MsgSend does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgSend) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "insta.nft.v1beta1.MsgSend.class_id":
		panic(fmt.Errorf("field class_id of message insta.nft.v1beta1.MsgSend is not mutable"))
	case "insta.nft.v1beta1.MsgSend.id":
		panic(fmt.Errorf("field id of message insta.nft.v1beta1.MsgSend is not mutable"))
	case "insta.nft.v1beta1.MsgSend.sender":
		panic(fmt.Errorf("field sender of message insta.nft.v1beta1.MsgSend is not mutable"))
	case "insta.nft.v1beta1.MsgSend.receiver":
		panic(fmt.Errorf("field receiver of message insta.nft.v1beta1.MsgSend is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.nft.v1beta1.MsgSend"))
		}
...
func (x *fastReflection_MsgSend) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.nft.v1beta1.MsgSend", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_insta_nft_v1beta1_tx_proto_init()
	md_MsgSendResponse = File_insta_nft_v1beta1_tx_proto.Messages().ByName("MsgSendResponse")
}
...
func (x *MsgSendResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_nft_v1beta1_tx_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_MsgSendResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.nft.v1beta1.MsgSendResponse"))
		}
		panic(fmt.Errorf("message insta.nft.v1beta1.MsgSendResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgSendResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.nft.v1beta1.MsgSendResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgSendResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.nft.v1beta1.MsgSendResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: insta/nft/v1beta1/tx.proto
...
func (*MsgSend) Descriptor() ([]byte, []int) {
	return file_insta_nft_v1beta1_tx_proto_rawDescGZIP(), []int{0}
}
...
func (*MsgSendResponse) Descriptor() ([]byte, []int) {
	return file_insta_nft_v1beta1_tx_proto_rawDescGZIP(), []int{1}
}

var File_insta_nft_v1beta1_tx_proto protoreflect.FileDescriptor

var file_insta_nft_v1beta1_tx_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x32, 0x4f, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12, 0x48, 0x0a, 0x04, 0x53,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0xbb, 0x01, 0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f,
	...
	0x3b, 0x6e, 0x66, 0x74, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0xa2, 0x02, 0x03, 0x43, 0x4e,
	0x58, 0xaa, 0x02, 0x12, 0x43, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x4e, 0x66, 0x74, 0x2e, 0x56,
	0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0xca, 0x02, 0x12, 0x43, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x5c,
	0x4e, 0x66, 0x74, 0x5c, 0x56, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0xe2, 0x02, 0x1e, 0x43, 0x6f,
	0x73, 0x6d, 0x6f, 0x73, 0x5c, 0x4e, 0x66, 0x74, 0x5c, 0x56, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31,
	0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x14, 0x43,
	0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x3a, 0x3a, 0x4e, 0x66, 0x74, 0x3a, 0x3a, 0x56, 0x31, 0x62, 0x65,
	0x74, 0x61, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_insta_nft_v1beta1_tx_proto_rawDescOnce sync.Once
	file_insta_nft_v1beta1_tx_proto_rawDescData = file_insta_nft_v1beta1_tx_proto_rawDesc
)

func file_insta_nft_v1beta1_tx_proto_rawDescGZIP() []byte {
	file_insta_nft_v1beta1_tx_proto_rawDescOnce.Do(func() {
		file_insta_nft_v1beta1_tx_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_nft_v1beta1_tx_proto_rawDescData)
	})
	return file_insta_nft_v1beta1_tx_proto_rawDescData
}

var file_insta_nft_v1beta1_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_insta_nft_v1beta1_tx_proto_goTypes = []interface{}{
	(*MsgSend)(nil),         // 0: insta.nft.v1beta1.MsgSend
	(*MsgSendResponse)(nil), // 1: insta.nft.v1beta1.MsgSendResponse
}
var file_insta_nft_v1beta1_tx_proto_depIdxs = []int32{
	0, // 0: insta.nft.v1beta1.Msg.Send:input_type -> insta.nft.v1beta1.MsgSend
	1, // 1: insta.nft.v1beta1.Msg.Send:output_type -> insta.nft.v1beta1.MsgSendResponse
...
func init() { file_insta_nft_v1beta1_tx_proto_init() }
func file_insta_nft_v1beta1_tx_proto_init() {
	if File_insta_nft_v1beta1_tx_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_insta_nft_v1beta1_tx_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_insta_nft_v1beta1_tx_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_nft_v1beta1_tx_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_insta_nft_v1beta1_tx_proto_goTypes,
		DependencyIndexes: file_insta_nft_v1beta1_tx_proto_depIdxs,
		MessageInfos:      file_insta_nft_v1beta1_tx_proto_msgTypes,
	}.Build()
	File_insta_nft_v1beta1_tx_proto = out.File
	file_insta_nft_v1beta1_tx_proto_rawDesc = nil
	file_insta_nft_v1beta1_tx_proto_goTypes = nil
	file_insta_nft_v1beta1_tx_proto_depIdxs = nil
}
