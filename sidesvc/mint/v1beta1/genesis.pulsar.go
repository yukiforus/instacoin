...
func init() {
	file_insta_mint_v1beta1_genesis_proto_init()
	md_GenesisState = File_insta_mint_v1beta1_genesis_proto.Messages().ByName("GenesisState")
...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_mint_v1beta1_genesis_proto_msgTypes[0]
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.mint.v1beta1.GenesisState.minter":
		return x.Minter != nil
	case "insta.mint.v1beta1.GenesisState.params":
		return x.Params != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.mint.v1beta1.GenesisState"))
		}
		panic(fmt.Errorf("message insta.mint.v1beta1.GenesisState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.mint.v1beta1.GenesisState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.mint.v1beta1.GenesisState", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: insta/mint/v1beta1/genesis.proto
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_insta_mint_v1beta1_genesis_proto_rawDescGZIP(), []int{0}
}
...
var File_insta_mint_v1beta1_genesis_proto protoreflect.FileDescriptor

var file_insta_mint_v1beta1_genesis_proto_rawDesc = []byte{
...
var (
	file_insta_mint_v1beta1_genesis_proto_rawDescOnce sync.Once
	file_insta_mint_v1beta1_genesis_proto_rawDescData = file_insta_mint_v1beta1_genesis_proto_rawDesc
)

func file_insta_mint_v1beta1_genesis_proto_rawDescGZIP() []byte {
	file_insta_mint_v1beta1_genesis_proto_rawDescOnce.Do(func() {
		file_insta_mint_v1beta1_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_mint_v1beta1_genesis_proto_rawDescData)
	})
	return file_insta_mint_v1beta1_genesis_proto_rawDescData
}

var file_insta_mint_v1beta1_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_insta_mint_v1beta1_genesis_proto_goTypes = []interface{}{
	(*GenesisState)(nil), // 0: insta.mint.v1beta1.GenesisState
	(*Minter)(nil),       // 1: insta.mint.v1beta1.Minter
	(*Params)(nil),       // 2: insta.mint.v1beta1.Params
}
var file_insta_mint_v1beta1_genesis_proto_depIdxs = []int32{
	1, // 0: insta.mint.v1beta1.GenesisState.minter:type_name -> insta.mint.v1beta1.Minter
	2, // 1: insta.mint.v1beta1.GenesisState.params:type_name -> insta.mint.v1beta1.Params
...
func init() { file_insta_mint_v1beta1_genesis_proto_init() }
func file_insta_mint_v1beta1_genesis_proto_init() {
	if File_insta_mint_v1beta1_genesis_proto != nil {
		return
	}
	file_insta_mint_v1beta1_mint_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_insta_mint_v1beta1_genesis_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_mint_v1beta1_genesis_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_insta_mint_v1beta1_genesis_proto_goTypes,
		DependencyIndexes: file_insta_mint_v1beta1_genesis_proto_depIdxs,
		MessageInfos:      file_insta_mint_v1beta1_genesis_proto_msgTypes,
	}.Build()
	File_insta_mint_v1beta1_genesis_proto = out.File
	file_insta_mint_v1beta1_genesis_proto_rawDesc = nil
	file_insta_mint_v1beta1_genesis_proto_goTypes = nil
	file_insta_mint_v1beta1_genesis_proto_depIdxs = nil
}
