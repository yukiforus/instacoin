...
func init() {
	file_insta_orm_v1alpha1_schema_proto_init()
	md_ModuleSchemaDescriptor = File_insta_orm_v1alpha1_schema_proto.Messages().ByName("ModuleSchemaDescriptor")
...
func (x *ModuleSchemaDescriptor) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_orm_v1alpha1_schema_proto_msgTypes[0]
...
func (x *fastReflection_ModuleSchemaDescriptor) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.orm.v1alpha1.ModuleSchemaDescriptor.schema_file":
		return len(x.SchemaFile) != 0
	case "insta.orm.v1alpha1.ModuleSchemaDescriptor.prefix":
		return len(x.Prefix) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.orm.v1alpha1.ModuleSchemaDescriptor"))
		}
		panic(fmt.Errorf("message insta.orm.v1alpha1.ModuleSchemaDescriptor does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ModuleSchemaDescriptor) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.orm.v1alpha1.ModuleSchemaDescriptor does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ModuleSchemaDescriptor) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "insta.orm.v1alpha1.ModuleSchemaDescriptor.prefix":
		panic(fmt.Errorf("field prefix of message insta.orm.v1alpha1.ModuleSchemaDescriptor is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.orm.v1alpha1.ModuleSchemaDescriptor"))
		}
...
func (x *fastReflection_ModuleSchemaDescriptor) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.orm.v1alpha1.ModuleSchemaDescriptor", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_insta_orm_v1alpha1_schema_proto_init()
	md_ModuleSchemaDescriptor_FileEntry = File_insta_orm_v1alpha1_schema_proto.Messages().ByName("ModuleSchemaDescriptor").Messages().ByName("FileEntry")
...
func (x *ModuleSchemaDescriptor_FileEntry) slowProtoReflect() protoreflect.Message {
	mi := &file_insta_orm_v1alpha1_schema_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_ModuleSchemaDescriptor_FileEntry) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "insta.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.id":
		return x.Id != uint32(0)
	case "insta.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.proto_file_name":
		return x.ProtoFileName != ""
	case "insta.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.storage_type":
		return x.StorageType != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry"))
		}
		panic(fmt.Errorf("message insta.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ModuleSchemaDescriptor_FileEntry) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message insta.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ModuleSchemaDescriptor_FileEntry) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "insta.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.id":
		panic(fmt.Errorf("field id of message insta.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry is not mutable"))
	case "insta.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.proto_file_name":
		panic(fmt.Errorf("field proto_file_name of message insta.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry is not mutable"))
	case "insta.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.storage_type":
		panic(fmt.Errorf("field storage_type of message insta.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: insta.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry"))
		}
...
func (x *fastReflection_ModuleSchemaDescriptor_FileEntry) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in insta.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: insta/orm/v1alpha1/schema.proto
...
func (StorageType) Descriptor() protoreflect.EnumDescriptor {
	return file_insta_orm_v1alpha1_schema_proto_enumTypes[0].Descriptor()
}

func (StorageType) Type() protoreflect.EnumType {
	return &file_insta_orm_v1alpha1_schema_proto_enumTypes[0]
}
...
func (StorageType) EnumDescriptor() ([]byte, []int) {
	return file_insta_orm_v1alpha1_schema_proto_rawDescGZIP(), []int{0}
}
...
type ModuleSchemaDescriptor_FileEntry struct {
	...
	// module has referenced using insta.app.v1.ModuleDescriptor.use_package.
	...
	StorageType StorageType `protobuf:"varint,3,opt,name=storage_type,json=storageType,proto3,enum=insta.orm.v1alpha1.StorageType" json:"storage_type,omitempty"`
}
...
func (*ModuleSchemaDescriptor_FileEntry) Descriptor() ([]byte, []int) {
	return file_insta_orm_v1alpha1_schema_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_insta_orm_v1alpha1_schema_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.MessageOptions)(nil),
		ExtensionType: (*ModuleSchemaDescriptor)(nil),
		Field:         104503792,
		Name:          "insta.orm.v1alpha1.module_schema",
		Tag:           "bytes,104503792,opt,name=module_schema",
		Filename:      "insta/orm/v1alpha1/schema.proto",
	},
}
...
var (
	...
	// themselves as app module config messages using the insta.app.v1.is_module
	// option.
	//
	// optional insta.orm.v1alpha1.ModuleSchemaDescriptor module_schema = 104503792;
	E_ModuleSchema = &file_insta_orm_v1alpha1_schema_proto_extTypes[0]
)

var File_insta_orm_v1alpha1_schema_proto protoreflect.FileDescriptor

var file_insta_orm_v1alpha1_schema_proto_rawDesc = []byte{
...
var (
	file_insta_orm_v1alpha1_schema_proto_rawDescOnce sync.Once
	file_insta_orm_v1alpha1_schema_proto_rawDescData = file_insta_orm_v1alpha1_schema_proto_rawDesc
)

func file_insta_orm_v1alpha1_schema_proto_rawDescGZIP() []byte {
	file_insta_orm_v1alpha1_schema_proto_rawDescOnce.Do(func() {
		file_insta_orm_v1alpha1_schema_proto_rawDescData = protoimpl.X.CompressGZIP(file_insta_orm_v1alpha1_schema_proto_rawDescData)
	})
	return file_insta_orm_v1alpha1_schema_proto_rawDescData
}

var file_insta_orm_v1alpha1_schema_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_insta_orm_v1alpha1_schema_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_insta_orm_v1alpha1_schema_proto_goTypes = []interface{}{
	(StorageType)(0),                         // 0: insta.orm.v1alpha1.StorageType
	(*ModuleSchemaDescriptor)(nil),           // 1: insta.orm.v1alpha1.ModuleSchemaDescriptor
	(*ModuleSchemaDescriptor_FileEntry)(nil), // 2: insta.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry
	(*descriptorpb.MessageOptions)(nil),      // 3: google.protobuf.MessageOptions
}
var file_insta_orm_v1alpha1_schema_proto_depIdxs = []int32{
	2, // 0: insta.orm.v1alpha1.ModuleSchemaDescriptor.schema_file:type_name -> insta.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry
	0, // 1: insta.orm.v1alpha1.ModuleSchemaDescriptor.FileEntry.storage_type:type_name -> insta.orm.v1alpha1.StorageType
	3, // 2: insta.orm.v1alpha1.module_schema:extendee -> google.protobuf.MessageOptions
	1, // 3: insta.orm.v1alpha1.module_schema:type_name -> insta.orm.v1alpha1.ModuleSchemaDescriptor
...
func init() { file_insta_orm_v1alpha1_schema_proto_init() }
func file_insta_orm_v1alpha1_schema_proto_init() {
	if File_insta_orm_v1alpha1_schema_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_insta_orm_v1alpha1_schema_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_insta_orm_v1alpha1_schema_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_insta_orm_v1alpha1_schema_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_insta_orm_v1alpha1_schema_proto_goTypes,
		DependencyIndexes: file_insta_orm_v1alpha1_schema_proto_depIdxs,
		EnumInfos:         file_insta_orm_v1alpha1_schema_proto_enumTypes,
		MessageInfos:      file_insta_orm_v1alpha1_schema_proto_msgTypes,
		ExtensionInfos:    file_insta_orm_v1alpha1_schema_proto_extTypes,
	}.Build()
	File_insta_orm_v1alpha1_schema_proto = out.File
	file_insta_orm_v1alpha1_schema_proto_rawDesc = nil
	file_insta_orm_v1alpha1_schema_proto_goTypes = nil
	file_insta_orm_v1alpha1_schema_proto_depIdxs = nil
}
